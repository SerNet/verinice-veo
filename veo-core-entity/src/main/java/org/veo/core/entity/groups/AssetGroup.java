...
/**
 * The group for Asset objects.
 */
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = true)
@ToString(onlyExplicitlyIncluded = true, callSuper = true)
public class AssetGroup extends BaseModelGroup<Asset> implements Asset, ModelGroup<Asset> {
    private Set<Asset> members = Collections.emptySet();
    @ToString.Include
    private Asset instance = new AssetImpl(null, null, null);
    ...
    public String getModelType() {
        return ModelPackage.ELEMENT_ASSET + "_GROUP";
    }

...
/**
 * The group for Control objects.
 */
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = true)
@ToString(onlyExplicitlyIncluded = true, callSuper = true)
public class ControlGroup extends BaseModelGroup<Control> implements Control, ModelGroup<Control> {
    private Set<Control> members = Collections.emptySet();
    @ToString.Include
    private Control instance = new ControlImpl(null, null, null);
    ...
    public String getModelType() {
        return ModelPackage.ELEMENT_CONTROL + "_GROUP";
    }

...
@Slf4j
public class ControlController extends AbstractCompositeElementController<Control, FullControlDto> {
  ...
  public CompletableFuture<ResponseEntity<ApiResponseBody>> deleteControl(
    ...
    return useCaseInteractor.execute(
        ...
        new DeleteElementUseCase.InputData(Control.class, uuid),
  ...
  public @Valid CompletableFuture<ResponseEntity<Set<Finding>>> inspect(
    ...
    return inspect(uuid, domainId, Control.class);
  }

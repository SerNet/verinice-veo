...
import org.veo.adapter.presenter.api.dto.ControlDto;
...
public class ControlController {
    ...
    public @Valid Flux<ControlDto> getControls(
    ...
    @Operation(summary = "Loads an control")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",
    ...
    public @Valid Mono<ControlDto> getControl(
    ...
    public Mono<Resource> createControl(@Valid @NotNull @RequestBody ControlDto controlData) {
        throw new VeoException(NOT_IMPLEMENTED, "Not implemented yet");
    }
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Control updated"),
            @ApiResponse(responseCode = "404", description = "Control not found") })
    public Mono<Resource> updateControl(@ParameterUuid @PathVariable(UUID_PARAM) String uuid,
            @Valid @NotNull @RequestBody ControlDto controlData) {
        throw new VeoException(NOT_IMPLEMENTED, "Not implemented yet");
    }
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Control deleted"),
            @ApiResponse(responseCode = "404", description = "Control not found") })
    public Mono<Resource> deleteControl(@ParameterUuid @PathVariable(UUID_PARAM) String uuid) {
        throw new VeoException(NOT_IMPLEMENTED, "Not implemented yet");
    }
}

...
public class ControlInDomainController implements ElementInDomainResource {
  ...
  @Operation(summary = "Loads the parents (scopes and composites) of a control in a domain")
  @ApiResponse(
      responseCode = "200",
  ...
  public GraphResultDto getControlGraph(
      ...
      @RequestParam(required = false, defaultValue = DEFAULT_GRAPH_NEIGHBORS_LIMIT)
          ...
          Integer limit) {
    return relationGraphService.getGraph(controlId, domainId, ElementType.CONTROL, locale, limit);
  }
}

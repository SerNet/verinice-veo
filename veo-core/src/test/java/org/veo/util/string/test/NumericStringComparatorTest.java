 ...
 *
 * From the Javadoc of java.util.Comparator: "Returns a negative integer, zero,
 * or a positive integer as the first argument is less than, equal to, or
 * greater than the second."
 *
 * -1: first is less than second 0: first is equal second 1: first is greater
 * than second
 *
 * English translation for "deutsche Umlaute" is "German umlaut":
 * http://www.dict.cc/?s=umlaut
 *
...
public class NumericStringComparatorTest {
    ...
    /**
     * See https://de.wikipedia.org/wiki/Alphabetische_Sortierung#Deutschland to
     * learn what DIN5007 Var.1 means.
     */
    @Test

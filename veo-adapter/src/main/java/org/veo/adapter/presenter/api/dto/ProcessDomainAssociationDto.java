...
import org.veo.core.entity.state.ProcessDomainAssociationState.ProcessDomainAssociationStateImpl;
...
public class ProcessDomainAssociationDto extends DomainAssociationDto {
  @Schema(
      description =
  ...
  public DomainAssociationState getDomainAssociationState(
    ...
    return new ProcessDomainAssociationStateImpl(

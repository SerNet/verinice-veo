...
/**
 * Swagger documentation for the reference 'owner' of 'Document':
 */

@Schema(name = "DocumentOwnerReference",
        description = "A reference to the unit containing this entity.")

public interface ModelObjectReferenceDocumentOwner extends IModelObjectReference {

    // TODO: update reference doc for DocumentOwner

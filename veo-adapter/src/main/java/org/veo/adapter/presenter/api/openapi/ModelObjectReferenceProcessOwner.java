...
@Schema(name = "ProcessOwnerReference",
        description = "A reference to the unit containing this entity.")

public interface ModelObjectReferenceProcessOwner extends IModelObjectReference {

    // TODO: update reference doc for ProcessOwner

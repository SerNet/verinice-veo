...
/**
 * Swagger documentation for the reference 'owner' of 'Person':
 */

@Schema(name = "PersonOwnerReference",
        description = "A reference to the unit containing this entity.")

public interface ModelObjectReferencePersonOwner extends IModelObjectReference {

    // TODO: update reference doc for PersonOwner

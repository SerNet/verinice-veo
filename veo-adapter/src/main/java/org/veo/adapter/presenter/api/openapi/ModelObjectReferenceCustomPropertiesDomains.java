 ...
 */
@Schema(name = "CustomPropertiesDomains", description = "The custom properties' domains")
public interface ModelObjectReferenceCustomPropertiesDomains extends IModelObjectReference {

...
public interface IdRefCatalogReferenceCatalogItem extends IIdRef {
  ...
  @Schema(
      description = "A friendly human readable title of the referenced catalog item.",
  ...
  @Schema(
      ...
      example =
          "http://<api.example.org>/api/v1/catalogitems/<00000000-0000-0000-0000-000000000000>",
      format = "uri")
  @Override
  String getTargetUri();

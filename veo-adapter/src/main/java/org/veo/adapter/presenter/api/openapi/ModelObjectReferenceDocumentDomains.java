...
/**
 * Swagger documentation for the reference 'domains' of 'Document': A model
 * object can have several domains. No domain would mean the default one.
 */

@Schema(name = "DocumentDomainsReference",
        description = "A reference to the unit containing this entity.")

public interface ModelObjectReferenceDocumentDomains extends IModelObjectReference {

    // TODO: update reference doc for DocumentDomains

    @Schema(description = "The domains of the document.", example = "ISO 27001:2013")
    @Override

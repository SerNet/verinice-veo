...
/**
 * Swagger documentation for the reference 'domains' of 'Process': A model
 * object can have several domains. No domain would mean the default one.
 */

@Schema(name = "ProcessDomainsReference",
        description = "A reference to the unit containing this entity.")

public interface ModelObjectReferenceProcessDomains extends IModelObjectReference {

    // TODO: update reference doc for ProcessDomains

    @Schema(description = "The domains of the process.", example = "ISO 27001:2013")
    @Override

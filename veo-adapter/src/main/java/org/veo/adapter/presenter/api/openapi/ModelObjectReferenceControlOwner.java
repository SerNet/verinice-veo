...
/**
 * Swagger documentation for the reference 'owner' of 'Control':
 */

@Schema(name = "ControlOwnerReference",
        description = "A reference to the unit containing this entity.")

public interface ModelObjectReferenceControlOwner extends IModelObjectReference {

    // TODO: update reference doc for ControlOwner

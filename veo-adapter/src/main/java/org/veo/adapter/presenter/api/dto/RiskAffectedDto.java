...
public interface RiskAffectedDto<T extends RiskAffected<T, ?>> extends RiskAffectedState<T> {
  Set<ControlImplementationDto> getControlImplementations();

  void setControlImplementations(Set<ControlImplementationDto> controlImplementations);

...
class GetAssetsUseCaseSpec extends UseCaseSpec {
    ...
    def "retrieve all assets for a client"() {
        ...
        when:
        def output = usecase.execute(new InputData(existingClient, null, null, null, null, null, null, null, null, null, null, null, null, null, pagingConfiguration))
    ...
    def "apply query conditions"() {
        ...
        }, null, null, Mock(QueryCondition), null, null, null, null, null, null, null, null, null, pagingConfiguration)

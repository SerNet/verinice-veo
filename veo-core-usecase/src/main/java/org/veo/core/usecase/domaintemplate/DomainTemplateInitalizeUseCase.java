...
public class DomainTemplateInitalizeUseCase
        implements TransactionalUseCase<EmptyInput, EmptyOutput> {
    private final DomainTemplateService templateService;

    public DomainTemplateInitalizeUseCase(DomainTemplateService templateService) {
    ...
    public EmptyOutput execute(EmptyInput input) {
        templateService.readTemplateFiles();

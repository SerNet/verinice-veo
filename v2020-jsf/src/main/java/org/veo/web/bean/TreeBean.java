...
public class TreeBean {
	...
	private PrimefacesTreeNode createRoot() {
		...
		if (logger.isDebugEnabled()) {
			logger.debug("transform elements stop: " + (System.currentTimeMillis() - currentTimeMillis));
		}
		return root;
	}

	private void tranformElements(HashMap<Element, PrimefacesTreeNode> hashMap, Set<Element> elements) {
		if (logger.isDebugEnabled()) {
